...
<table class="table table-bordered table-hover table-sm text-center">
  ...
  <tbody>
    ...
    <tr class="justify-content-center">
        ...
        <td><?php if ($comment->moderationStatus() == 1) { echo 'Oui';} else { echo 'Non';} ?></td>
        <td>
          <a href="index.php?action=displayComment&amp;id=<?= $comment->id() ?>">
            <img src="https://img.icons8.com/plasticine/100/000000/search-more.png">
          </a>
          <a data-toggle="modal" id="comment-<?=$comment->id()?>" data-action="delete" href="#deleteModal">
